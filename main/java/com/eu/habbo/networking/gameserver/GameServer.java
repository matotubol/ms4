...
public class GameServer extends Server {
    ...
    public void initializePipeline() {
        ...
        this.serverBootstrap.childHandler(new GameServerChannelInitializer());
    }

    private class GameServerChannelInitializer extends ChannelInitializer<SocketChannel> {
        @Override
        ...
        private void setupLogger(SocketChannel ch) {
            ch.pipeline().addLast("logger", new LoggingHandler());
        }

        private void setupDecoders(SocketChannel ch) {
